    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:block lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 border-2 border-background rounded-full" />
        </div>
        <div className="relative z-10 h-full flex items-center justify-center p-12 text-center">
          <div>
            ...
            <p className="text-xl text-background/80 max-w-md mx-auto">
              Join thousands of learners who have transformed their careers with SkillUp
            </p>
          </div>
        </div>
      </div>
